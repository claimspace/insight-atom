...
export default {
  ...
  config: {
    datadir: {
      title: 'Insight Data Location',
      description: 'Where Insight projects will be stored on your computer. If you change this, make sure to copy any existing data to the new location.',
      type: 'string',
      default: null
    }
  },
